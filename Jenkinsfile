pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Hibbarkm/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('hibbarkm-225')   // <---- Change this to match your kubernetes cluster credentials
    }
